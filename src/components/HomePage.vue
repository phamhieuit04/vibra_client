...
async function FetchAlbumData() {
    try {
        const res = await axios.get(
            'http://spotify_clone_api.test/api/home/list-album',
            {
                headers: {
...
async function FetchArtistData() {
    try {
        const res = await axios.get(
            'http://spotify_clone_api.test/api/home/list-artist',
            {
                headers: {
                    Authorization: 'Bearer ' + authStore.user.token,
                },
...
async function FetchSongData() {
    try {
        const res = await axios.get(
            'http://spotify_clone_api.test/api/home/list-song',
            {
                headers: {
                    Authorization: 'Bearer ' + authStore.user.token,
                },
...
async function playThisAlbum(id) {
    try {
        const res = await axios.get(
            `http://spotify_clone_api.test/api/playlist/show/${id}`,
            {
                headers: {
                    Authorization: 'Bearer ' + authStore.user.token,
                },
