...
async function getCategoriesSong() {
    try {
        const res = await axios.get(
            `http://spotify_clone_api.test/api/category/show/${categoriesData.value.id}`,
            {
                headers: {
...
<template>
    <div class="text-[#FFFF]">
        <div
            class="scrollbar-style h-[calc(100vh-190px)] w-full overflow-y-auto px-16 pt-4"
        >
                ...
                <div v-if="songByCateList.length > 4" class="flex">
                    ...
                    >
                        ...
                        <div class="mt-4 pr-8 text-center">
                            ...
                            <div
                                class="mt-1 flex items-center justify-center gap-2 text-sm text-zinc-400"
                            >
                                <p>
